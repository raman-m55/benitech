    ...
    <header className="w-full fixed z-50">
      ...
      >
        ...
        <Button className="bg-blue-600 text-white flex items-center justify-between gap-4 py-3">
          ...
          <div className="absolute right-0 top-0 transition group-hover:translate-y-5 translate-y-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible duration-500 ease-in-out group-hover:transform z-50 min-w-[560px] transform rounded-md
          max-md:hidden">
              ...
              {categories.map(category => (
                ...
                >
                   {category.subcategories.map((item) => (
                    <p className='hover:text-blue-300 text-sm
